import { expect, test as liveTest } from 'vitest';
import { Anizone } from '../src/provider/anime/anizone';

// These integration checks contact a real provider and are excluded from the offline default suite.
const test = liveTest.skip;
